...
class SubCategoriaEdit(LoginRequiredMixin, generic.UpdateView): #CreateView, Django interpretara que se insertaran datos
    model = SubCategoria
    template_name = "inv/subcategoria_form.html"
    context_object_name = "obj"
    form_class= SubCategoriaForm
...
class SubCategoriaDelete(LoginRequiredMixin, generic.DeleteView): #CreateView, Django interpretara que se insertaran datos
    model = SubCategoria
    template_name = "inv/catalogos_del.html"
    context_object_name = "obj"
    success_url= reverse_lazy("inv:subcategoria_list")
...
class MarcaNew(LoginRequiredMixin, generic.CreateView): #CreateView, Django interpretara que se insertaran datos
    model = Marca
...
class MarcaEdit(LoginRequiredMixin, generic.UpdateView): #CreateView, Django interpretara que se insertaran datos
    model = Marca
    template_name = "inv/marca_form.html"
    context_object_name = "obj"
    form_class= MarcaForm
